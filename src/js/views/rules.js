	...
	return (
		<div className="text-center mt-5 mb-5 row justify-content-center">
			<p>
				...
				them face down in three rows in front of each player. Deal six cards to each player face down. Players
				may look at these cards in their hand. Players select three cards from their hand and place them face up
				on the three face down cards in front of them. Typically, higher value cards are placed face up. Place
				the remaining cards face down in the center of the table to form the Draw pile.
				<h3>
				...
				the same numbers are played in a row, either by one player or multiple players, it clears the discard
